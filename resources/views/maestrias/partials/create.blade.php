                                <div class="row gy-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control " id="institucion1"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="year1" name="apellidos"
                                                    placeholder="Ejm: 2012">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <button id="aggMaestria" type="button"
                                            class="btn btn-sm btn-success mt-4">Agregar</button>
                                    </div>
                                    <div class="col-md-12">
                                        <table id="Maestria" class="table">
