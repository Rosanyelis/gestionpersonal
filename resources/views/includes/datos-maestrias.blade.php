<div class="nk-block">
    <div class="nk-block-head nk-block-head-sm nk-block-between badge badge-dark p-1">
        <h5 class="title text-white text-uppercase">Maestrías</h5>
        <a href="{{ url('/personal/' . $data->id . '/maestrias/nueva-maestria') }}"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="link-list-opt no-bdr">
                                        <li>
                                            <a
                                                href="{{ url('/personal/' . $data->id . '/maestrias/' . $item->id . '/editar-maestria') }}">
                                        ...
                                        <li>
                                            ...
                                            <form id="formDelete-{{ $item->id }}"
                                                action="{{ url('/personal/' . $data->id . '/maestrias/' . $item->id . '/eliminar-maestria') }}"method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </li>
