                                <div class="row gy-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control " id="institucion4"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control " id="titulo4" name="titulo"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="year4" name="apellidos"
                                                    placeholder="Ejm: 2012">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <button id="aggCursos" type="button"
