                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt">
                                        <a href="{{ url('configuraciones/usuarios/nuevo-usuario') }}" class="btn btn-primary">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="link-list-opt no-bdr">
                                                <li><a href="{{ url('configuraciones/usuarios/'.$item->id.'/ver-usuario') }}"><em class="icon ni ni-eye"></em><span>Ver Usuario</span></a></li>
                                                <li><a href="{{ url('configuraciones/usuarios/'.$item->id.'/editar-usuario') }}"><em class="icon ni ni-edit"></em><span>Editar Usuario</span></a></li>
                                                <li>
                                                    <button class="btn delete-record" data-id="{{ $item->id }}">
                                                        <em class="icon ni ni-trash"></em>
                                                        <span>Eliminar Usuario</span>
                                                    </button>
                                                    <form id="formDelete-{{ $item->id }}" action="{{ url('configuraciones/usuarios/'.$item->id.'/eliminar-usuario') }}"method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
