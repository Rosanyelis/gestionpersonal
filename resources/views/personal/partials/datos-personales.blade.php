                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="fw-vr-apodo"
                                                            name="apodo" value="{{ old('apodo') }}"
                                                            placeholder="Ejm: Jena">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="form-control-select">
                                                        <select class="form-control" name="estado_civil"
                                                            ...
                                                            <option value="Soltero(a)"
                                                                @if (old('estado_civil') == 'Soltero(a)') selected @endif>Soltero(a)
                                                            </option>
                                                            <option value="Casado(a)"
                                                                @if (old('estado_civil') == 'Casado(a)') selected @endif>Casado(a)
                                                            </option>
                                                            <option value="Viudo(a)"
                                                                @if (old('estado_civil') == 'Viudo(a)') selected @endif>Viudo(a)
                                                            </option>
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="fw-vr-lugar"
                                                            name="tipo_sangre" value="{{ old('tipo_sangre') }}"
                                                            placeholder="Ejm: ORH+">
